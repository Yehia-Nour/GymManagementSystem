        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingNumber = table.Column<int>(type: "int", maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhoneCheck", "Phone Like '01%' And Phone Like '%[0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhoneCheck1", "Phone Like '01%' And Phone Like '%[0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MembersShips_Plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembersSessions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembersSessions_MemberId",
